...
public class ExprComponent extends PropertyExpression<String, Component> {
	...
	protected Component[] get(final Event e, final String[] source) {
		// i want to sleep
		return get(source, s -> BungeeComponentSerializer.get().deserialize(BungeeConverter.convert(ChatMessages.parse(s))));
	}
	...
	public String toString(final @Nullable Event e, final boolean debug) {
		return "old component " + getExpr().toString(e, debug);
	}
